        ...
        <div className="space-y-4">
            ...
            <div className="space-y-4">
                <div>
                    ...
                    >
                        <option value="gemini-2.5-flash">Gemini 2.5 Flash (推奨・高速・安定)</option>
                        <option value="gemini-2.5-pro">Gemini 2.5 Pro (高品質・安定)</option>
                        <option value="gemini-3-flash-preview">Gemini 3 Flash Preview (実験的・無料枠制限あり)</option>
                        <option value="gemini-3.1-pro-preview">Gemini 3.1 Pro Preview (実験的・高コスト)</option>
                    </select>
                </div>
