                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <select value={modelName} onChange={(e) => onModelChange(e.target.value)} className="w-full bg-slate-950 border border-slate-800 rounded-lg p-3 text-base text-slate-200 focus:ring-2 focus:ring-indigo-500 outline-none">
                                <option value="gemini-3.5-flash">Gemini 3.5 Flash (最新・推奨・最高コスパ)</option>
                                <option value="gemini-3-flash-preview">Gemini 3 Flash (旧バージョン)</option>
                ...
                {isLoading ? (
                    <>
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-lg">{loadingMessage} {loadingProgress}%</span>
                        </div>
                        <div className="w-full max-w-sm mt-3">
                            <div className="h-2 bg-slate-700 rounded-full overflow-hidden relative">
                                <div className="h-full bg-gradient-to-r from-indigo-400 to-violet-400 rounded-full transition-all duration-500 ease-out" style={{ width: `${loadingProgress}%` }} />
                            </div>
                        </div>
                    </>
                ) : (
